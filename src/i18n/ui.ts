...
export const ui = {
  pl: {
    ...
    'home.hero.lede':
      'Tworzę dostępne media, aplikacje i narzędzia do codziennego użytku.',
    ...
    'work.intro':
      'Nie rozdzielam pracy od pasji. Poniżej rzeczy, które tworzę, współtworzę i rozwijam.',
    'work.visit': 'Otwórz',
    ...
    'about.p1':
      'Nazywam się Michał Dziwisz. Od lat tworzę media, aplikacje i narzędzia, które mają ułatwiać codzienne korzystanie z technologii. Jako osoba niewidoma traktuję dostępność cyfrową osobiście, bo decyduje ona o tym, czy z danej rzeczy w ogóle da się skorzystać. Wolę więc robić rzeczy potrzebne i zrozumiałe niż efektowne.',
    'about.p2':
      'Jestem pomysłodawcą i redaktorem naczelnym serwisu TyfloPodcast, poświęconego technologii i dostępności dla osób niewidomych i słabowidzących. Współtworzę też format kanału głównego Radia DHT. Piszę również programy: aplikacje TyfloCentrum dla systemów Windows, Android i iOS, system automatyzacji radiowej SARA, a obok nich mniejsze narzędzia, takie jak Podróżnik czy program do usuwania podpisów z plików PDF.',
    'about.p3':
      'Łączy je dostępność. Myślę o niej od początku, zamiast dokładać ją na końcu gotowego projektu. Tak też powstała ta strona: ma dobrze działać z czytnikiem ekranu, dawać się wygodnie obsługiwać z klawiatury i pozostawać czytelna w trybie jasnym i ciemnym.',
  ...
  en: {
    ...
    'home.hero.lede':
      'I create accessible media, apps and tools for everyday use.',
    ...
    'work.intro':
      "I don't separate work from passion. Below are the things I create, co-create and maintain.",
    'work.visit': 'Open',
    ...
    'about.p1':
      'My name is Michał Dziwisz. For years I have been creating media, apps and tools that make everyday use of technology easier. As someone who is blind, digital accessibility matters to me personally, because it decides whether a thing can be used at all. So I would rather build things that are needed and clear than things that merely look impressive.',
    'about.p2':
      "I am the founder and editor-in-chief of TyfloPodcast, a site about technology and accessibility for blind and partially sighted people. I also help develop the format of Radio DHT's main channel. I write software too: the TyfloCentrum apps for Windows, Android and iOS, the SARA radio automation system, and alongside them smaller tools such as Podróżnik and a utility for removing signatures from PDF files.",
    'about.p3':
      'Accessibility is what ties these projects together. I think about it from the start, instead of adding it to a finished project at the end. This website was built the same way: it is meant to work well with screen readers, be easy to use with a keyboard, and remain readable in both light and dark modes.',
