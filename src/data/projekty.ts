...
export const projects: Project[] = [
  ...
  },
  {
    id: 'bookamp',
    featured: true,
    namePl: 'Bookamp i Bookbar',
    nameEn: 'Bookamp & Bookbar',
    descPl:
    ...
    links: [
      {
        ...
        labelEn: 'Download Bookamp (Winamp)',
        a11yPl: 'Pobierz Bookampa (Winamp) z wydań na GitHubie',
        a11yEn: 'Download Bookamp (Winamp) from the GitHub releases',
        href: 'https://github.com/michaldziwisz/bookamp/releases/latest',
      },
      {
        labelPl: 'Pobierz Bookbara (foobar2000)',
        labelEn: 'Download Bookbar (foobar2000)',
        a11yPl: 'Pobierz Bookbara (foobar2000) z wydań na GitHubie',
        a11yEn: 'Download Bookbar (foobar2000) from the GitHub releases',
        href: 'https://github.com/michaldziwisz/bookbar/releases/latest',
      },
      {
        labelPl: 'Kod źródłowy Bookampa',
        labelEn: 'Bookamp source code',
        a11yPl: 'Kod źródłowy Bookampa na GitHubie',
        a11yEn: 'Bookamp source code on GitHub',
        href: 'https://github.com/michaldziwisz/bookamp',
      },
      {
        labelPl: 'Kod źródłowy Bookbara',
        labelEn: 'Bookbar source code',
        a11yPl: 'Kod źródłowy Bookbara na GitHubie',
        a11yEn: 'Bookbar source code on GitHub',
        href: 'https://github.com/michaldziwisz/bookbar',
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        labelEn: 'Download QAT for Winamp',
        a11yPl: 'Pobierz QAT dla Winampa z wydań na GitHubie',
        a11yEn: 'Download QAT for Winamp from the GitHub releases',
        href: 'https://github.com/michaldziwisz/qat-winamp/releases/latest',
      },
      {
        labelPl: 'Pobierz QAT dla foobara2000',
        labelEn: 'Download QAT for foobar2000',
        a11yPl: 'Pobierz QAT dla foobara2000 z wydań na GitHubie',
        a11yEn: 'Download QAT for foobar2000 from the GitHub releases',
        href: 'https://github.com/michaldziwisz/qat-foobar/releases/latest',
      },
      {
        labelPl: 'Kod źródłowy QAT (Winamp)',
        labelEn: 'QAT source code (Winamp)',
        a11yPl: 'Kod źródłowy QAT (Winamp) na GitHubie',
        a11yEn: 'QAT source code (Winamp) on GitHub',
        href: 'https://github.com/michaldziwisz/qat-winamp',
      },
      {
        labelPl: 'Kod źródłowy QAT (foobar2000)',
        labelEn: 'QAT source code (foobar2000)',
        a11yPl: 'Kod źródłowy QAT (foobar2000) na GitHubie',
        a11yEn: 'QAT source code (foobar2000) on GitHub',
        href: 'https://github.com/michaldziwisz/qat-foobar',
      },
    ],
  },
];
